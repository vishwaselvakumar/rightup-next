          ...
          <div className="flex">
            ...
            <div className="ml-4">
              ...
              <p className="mt-2 ">
                ...
                capabilities, providing a better and more uninterrupted learning
                experience.
              </p>
            </div>
          </div>
      ...
      <div className="mx-auto max-w-xl px-6 lg:mx-0 lg:max-w-none lg:py-16 lg:px-0 ">
        <div>
          ...
          <div className="mt-6">
            ...
            <div className="mt-6">
              <a
                className="inline-flex rounded-lg bg-blue-600 px-4 py-1.5 text-base font-semibold leading-7 text-white shadow-sm ring-1 ring-blue-600 hover:bg-blue-700 hover:ring-pink-700"
                href="/login"
              >
                Contact 
              </a>
